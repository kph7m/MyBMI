...
class HistoryFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val sectionState = RecyclerState(RecyclerType.SECTION, "２月","","","","","")
        states.add(sectionState)

        val state = RecyclerState(RecyclerType.BODY,"", "10日","１８１cm","８５kg","26.5","あのねのね")
        states.add(state)


//        stateRecyclerView.adapter = RecyclerAdapter(context!!, states)
